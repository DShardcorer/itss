...
public class Response {
    ...
    public Response(String query) {
        // SRP Violation: Constructor parses the query string and sets fields.
    ...
    // Handles exceptions based on the response code
    private void handleException() throws TransactionNotDoneException, TransactionFailedException, TransactionReverseException, UnrecognizedException {
        // SRP Violation: Business logic mixed with data handling.
        // OCP Violation: Hard-coded response codes, not extendable without modification.
