...
import java.util.ArrayList;
    //violate single responssiblity
    //high data coupling as it directly interacts with the db
    // Order class and the database (AIMSDB) for storing and retrieving invoice-related data.
